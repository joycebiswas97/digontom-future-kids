...
function Hero() {
    return (
        <section className="bg-[#0a0a0a] text-white flex items-center justify-center relative overflow-hidden px-6 md:px-12 pt-25 pb-10">
            ...
            <div className="max-w-7xl mx-auto w-full grid grid-cols-1 md:grid-cols-2 gap-12 items-center relative z-10">
                {/* Hero Text Content */}
                <div className="flex flex-col items-start justify-center space-y-6 lg:pr-8 lg:pb-10">
                    ...
                    <p className="text-md md:text-lg text-gray-300 max-w-lg leading-relaxed">
