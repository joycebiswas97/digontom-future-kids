    ...
    return (
        <footer className="bg-[#020617] text-white pt-10 md:pt-20 pb-10 px-5 md:px-5 relative border-t border-white/5">
            <div className="max-w-7xl mx-5 md:mx-10">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
                    ...
                    <div className="flex flex-col space-y-6">
                        <div classname="flex items-center gap-2">
                            <img src={image} alt="Digontom Logo" className="h-12 object-contain self-start" />
                            <h1 className="text-2xl font-bold">digontom future kids</h1>
                        </div>
                        <p className="text-[#B3B3B3] text-md leading-relaxed max-w-xs">
                    ...
                    <div>
                        ...
                        <p className="text-[#B3B3B3] text-md mb-6">
                ...
                {/* Divider */}
                <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center text-md text-[#B3B3B3]">
